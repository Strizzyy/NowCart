...
def _build_demo_vision_cart(session_id: str) -> Cart:
    ...
    cart.items = [
        CartItem(
            ...
            quantity=1,
            unit="200 g",
            reason="Main protein ΓÇö the star of this curry",
            confidence=0.97,
        ...
        CartItem(
            ...
            quantity=3,
            unit="pcs",
            reason="Base for gravy ΓÇö saut├⌐ed until golden",
            confidence=0.95,
    ...
    cart.economical_items = [
        CartItem(
            ...
            quantity=1,
            unit="200 g",
            reason="Budget-friendly pick (saves Γé╣15)",
            confidence=0.91,
            image_url="https://www.bigbasket.com/media/uploads/p/s/40005958_2-gowardhan-fresh-paneer-classic-block.jpg",
        ),
        CartItem(
            ...
            quantity=3,
            unit="pcs",
            reason="Budget-friendly pick (saves Γé╣7)",
            confidence=0.90,
            image_url="https://www.bigbasket.com/media/uploads/p/s/40075537_5-fresho-onion.jpg",
        ),
        CartItem(
            ...
            quantity=1,
            unit="100 g",
            reason="Budget-friendly pick (saves Γé╣3)",
            confidence=0.89,
        ...
        CartItem(
            ...
            quantity=1,
            unit="50 g",
            reason="Budget-friendly pick (saves Γé╣14)",
            confidence=0.90,
        ...
        CartItem(
            ...
            quantity=4,
            unit="pcs",
            reason="Budget-friendly pick (saves Γé╣8)",
            confidence=0.90,
